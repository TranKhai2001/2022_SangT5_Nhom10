...
public class Payment {
    public static void checkValidData(Connection con,List<Cart> products) throws SQLException {
        for (Cart cart:products
            ...
            CartFunctions.check_amount_in_warehouse(con, id_product, amount);
        }
    ...
    public static synchronized void payment(String id_user,String address,String state,double total_money,String phone_number)  {
        try {
            ...
            List<Cart> products = CartFunctions.watch(id_user);
            //check is amount still valid?
            checkValidData(con, products);
            //buy time!
            //get the latest id in table
            String id = Register.nextID(con, "bill", "id_bill", "BI");
...
//            try {
            ...
            for (Cart cart : products
                ...
                CartFunctions.deleteProduct(id_user, cart.getProduct().getId_product());
            }
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        payment(id_user,"java ranch","đã thanh toán",CartFunctions.totalMoney(id_user),"0123445679");
    }
}
