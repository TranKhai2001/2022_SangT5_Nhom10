package com.example.the_final_term20220216.dao;

import com.example.the_final_term20220216.functions.CommentProduct;
import com.example.the_final_term20220216.functions.Comment_vote;
import com.example.the_final_term20220216.functions.IComment;
...
//        List<Product> hotRawProducts = ProductClassification.productHot();
//        List<Product> discountRawProducts = ProductClassification.productForSale();
//        discountRawProducts.sort(new Comparator<Product>() {
//            @Override
//            public int compare(Product o1, Product o2) {
//                return Integer.compare(o1.getAmount_bought(),o2.getAmount_bought());
//            }
//        });
